...
Процедура СписокПередНачаломИзменения(Элемент, Отказ)
	...
	Если (Элементы.Список.ТекущийЭлемент.Имя = "Документ" ИЛИ Элементы.Список.ТекущийЭлемент.Имя = "Комментарий") 
			И ЗначениеЗаполнено(Элементы.Список.ТекущиеДанные.Документ) Тогда
